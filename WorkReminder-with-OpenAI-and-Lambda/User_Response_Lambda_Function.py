"""
-*- coding: utf-8 -*-
@File  : User_Response_Lambda_Function.py
@author: mingyu110
@Description : 
@Time  : 2024/07/01
"""
...
def lambda_handler(event, context):
    ...
    try:
        with connection.cursor() as cursor:
            ...
            sql = """
            SELECT id, chatid, task_name, notification_timestamp 
            FROM taskreminder
                ...
                if last_message:
                    ...
                    if text == 'yes':
                        ...
                        send_telegram_message(telegram_token, chat_id,
                                              f"Great! You've confirmed taking your {task_name}. Your score has been "
                                              f"increased by 1.")
                    elif text == 'no':
                        ...
                        connection.commit()
                        send_telegram_message(telegram_token, chat_id,
                                              f"Please remember to take your {task_name} as soon as possible. Your "
                                              f"score has been decreased by 1.")
                else:
                    ...
                    connection.commit()
                    send_telegram_message(telegram_token, chat_id,
                                          f"You missed taking your {task_name}. Your score has been decreased by 1. "
                                          f"Please remember to take it as soon as possible.")
