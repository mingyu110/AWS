"""
-*- coding: utf-8 -*-
@File  : Dispatcher_Lambda_Function.py
@author: mingyu110
@Description : 
@Time  : 2024/06/29
"""
...
def lambda_handler(event, context):
    # The incoming event should be logged for debugging purposes
    ...
    try:
        ...
        if text == "/start":
            ...
            send_telegram_message(os.environ['TELEGRAM_TOKEN'], chat_id,
                                  "Hello! Welcome to the WorkReminder bot. Use /add to add a medication or /summary to get a summary of your work tasks.")
